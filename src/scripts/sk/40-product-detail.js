/* ⚠️ GENEROVANÝ SOUBOR — NEEDITOVAT.
   Vzniká z src/scripts/40-product-detail.js + i18n/sk-texty.mjs příkazem: node build-sk.mjs
...
(function () {
  ...
  function reviewCard(r) {
    ...
    stars.src = STARS;
    stars.alt = "Hodnotenie 5 z 5 hviezd";
    stars.loading = "lazy";
    ...
    verified.appendChild(document.createTextNode(" Overený zákazník"));
  ...
  function injectHeureka(root) {
    ...
    el.innerHTML =
      '<img src="' + HEUREKA +
      '" width="123" height="48" alt="97 % zákazníkov odporúča — Overené zákazníkmi Heureka" loading="lazy">';
  ...
  var SOCK_RE = /ponožk|podkolienk|podkolenk/i;
  ...
  function fixDeliveryLabel(root) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      node.nodeValue = node.nodeValue.replace("Ponožky budú u vás", "Tovar bude u vás");
      break;
    }
  }
  ...
  var FAQ = [
    {
      ico: "🧦",
      title: "Produkt a starostlivosť o ponožky",
      qa: [
        [
    ...
    {
      ico: "⚡",
      title: "Rýchlosť doručenia a expedície",
      qa: [
        [
    ...
    },
    {
      ...
      qa: [
        ...
        [
          ...
          "Stačí vyplniť náš jednoduchý <a href=\"/cms/61618-vraceni-zbozi\">online " +
    ...
    {
      ico: "🏭",
      title: "Pôvod tovaru a certifikácie",
      qa: [
        [
    ...
    {
      ico: "🤝",
      title: "Veľkoobchod a zákazková výroba (B2B)",
      qa: [
        [
          "Ako sa stať vaším veľkoobchodným partnerom a získať VO cenník?",
          "Stačí vyplniť náš <a href=\"/cms/61606-velkoobchodni-spoluprace\">B2B " +
        ...
        [
          ...
          "Áno! <a href=\"/cms/61603-vyroba-na-zakazku\">Zákazková výroba</a> na mieru je " +
  ...
  var TAB_STATIC = [
    ...
    { label: "Časté otázky", html: faqHtml() }
  ];
  ...
  var ALSO_TITLE = "Zákazníci tiež nakupujú";   // fallback, když h2 chybí
  var ALSO_CTA = "Pridať do košíka";
  ...
  var SIZE_LINK_TEXT = "Tabuľka veľkostí";
  var SIZE_MODAL_TITLE = "Tabuľka veľkostí";
  ...
  function buildSizeModal() {
    ...
    dlg.innerHTML =
      '<div class="pd-size__head">' +
        ...
        '<button type="button" class="pd-size__close" aria-label="Zavrieť">' +
