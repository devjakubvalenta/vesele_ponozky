/* ⚠️ GENEROVANÝ SOUBOR — NEEDITOVAT.
   Vzniká z src/scripts/footer.js + i18n/sk-texty.mjs příkazem: node build-sk.mjs
...
(function () {
  ...
  var NEWSLETTER = {
    ...
    title: 'NEZMEŠKAJTE<br>ŽIADNE NOVINKY<br><span class="vp-nl__accent">A ZÍSKAJTE ZĽAVU 15%!</span>',
    // mezera PŘED <br> je schválně: když se `<br>` na mobilu vypne, drží slova
    // od sebe; na desktopu se na konci řádku stejně sbalí
    lead: "Prihláste sa na odber nášho newslettera a získajte <br class=\"vp-nl__br\">zľavu 15 % na váš prvý nákup veselých ponožiek.",
    ...
    code: "VESELE15",
    codeLead: "Váš zľavový kód na 15 %:",
    ...
    // a jako tooltip.
    copyLabel: "Skopírovať kód",
    copiedLabel: "Skopírované"
  };
  ...
  var REVIEWS = [
    { text: "Všetko v úplnom poriadku. Rýchlosť. Kvalita. Odporúčam.", name: "Ondra" },
    { text: "Rýchle dodanie, skvelá komunikácia, ochota a ústretovosť.", name: "Blanka" },
    ...
    { text: "Ponožky z tohto obchodu sú naozaj veľmi kvalitné, pružné a dobre „sedia\". Dodanie tovaru bolo veľmi rýchle, za 2 dni od objednávky.", name: "Lenka" }
  ];
  var BADGES = [
    { icon: ASSET.customers, num: "130 000+", label: "Spokojných zákazníkov" },
    { icon: ASSET.rating, stars: true, label: "Priemerné hodnotenie" },
    { icon: ASSET.trust, num: "97 %", label: "Odporúča naše ponožky" }
  ];
  ...
  function reviewCard(r) {
    return (
      ...
      '<img class="vp-foot__stars" src="' + ASSET.stars + '" alt="Hodnotenie 5 z 5" loading="lazy">' +
      ...
      '<span class="vp-foot__verified">' + CHECK + " Overený zákazník</span>" +
      "</div></div></div>"
    );
  }
  ...
  function badge(b) {
    var top = b.stars
      ? '<img class="vp-foot__badge-stars" src="' + ASSET.stars +
        '" alt="Hodnotenie 4,9 z 5" loading="lazy">'
  ...
  function buildTop() {
    ...
    wrap.innerHTML =
      ...
      '<div class="vp-foot__logo"><img src="' + ASSET.logo + '" alt="Veseléponožky.sk" loading="lazy"></div>' +
      "</div>";
    return wrap;
  }
  ...
  function buildPayments() {
    ...
    d.innerHTML =
      ...
      '" target="_blank" rel="noopener noreferrer" aria-label="Platobná brána Comgate">' +
      PAY_LOGO.comgate + "</a>" +
