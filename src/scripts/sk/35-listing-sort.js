/* ⚠️ GENEROVANÝ SOUBOR — NEEDITOVAT.
   Vzniká z src/scripts/35-listing-sort.js + i18n/sk-texty.mjs příkazem: node build-sk.mjs
...
(function () {
  ...
  var PRICE_FIRST = ["1254445"];   // Výprodej až -90 %
  var SALES_MARK = "vp-sort=sales";

  // Cesta kategorie BEZ řadicího/stránkovacího segmentu:
  //   /c/1254445-vyprodej-az-90             (produkce)
  //   /shops/28056/c/1254445-vyprodej-az-90 (technická adresa)
  ...
  function build(scope) {
    ...
    Array.prototype.forEach.call(selects, function (sel) {
      ...
      nav.setAttribute("aria-label", "Zoradenie");
