/* ⚠️ GENEROVANÝ SOUBOR — NEEDITOVAT.
   Vzniká z src/scripts/header.js + i18n/sk-texty.mjs příkazem: node build-sk.mjs
...
(function () {
  ...
  var SIDE_CATEGORIES = [
    { id: "1254433", color: "c1", name: "Pánske Veselé ponožky" },          // červená
    { id: "1254436", color: "c2", name: "Dámske Veselé ponožky" },      // žlutá
    { id: "1254439", color: "c3", name: "Detské Veselé ponožky" },               // modrá
    { id: "1254442", color: "c4", name: "Darčekové sety" }  // zelená
  ];
  ...
  function insertHeureka(middleRow, logo) {
    ...
    el.innerHTML =
      ...
      '" width="157" height="48" alt="97 % zákazníkov odporúča — Overené zákazníkmi Heureka" loading="lazy">';
  ...
  /* == Pojistka: URL s technickou doménou → cesta od kořene =============
     ...
     technickou adresu shopu („starý eshop"). Přepisujeme je za běhu:
       …exitshop.cz/shops/28056/cms/61609-x → /cms/61609-x  (na testu /shops/28056/cms/…)
